...
public class CategoryController {
    ...
    @GetMapping
    public ResponseDTO<CustomPage<CategoryDTO>> viewCategories(@RequestParam(name = "search", defaultValue = "") String search,
                                                                 @RequestParam(name = "page", defaultValue = "0") int page,
                                                                 @RequestParam(name = "limit", defaultValue = "-1") int limit){
        ResponseDTO<CustomPage<CategoryDTO>> responseDTO = new ResponseDTO<>();
